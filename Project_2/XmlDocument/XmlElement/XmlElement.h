...
namespace XmlProcessing
{
  ...
  public:
	...
	virtual std::vector<std::pair<std::string, std::string>>& attribte()=0;
  ...
  public:
	...
	virtual std::vector<std::shared_ptr<AbstractXmlElement>>& children() { return children_;}
	virtual std::vector<std::pair<std::string, std::string>>& attribte(){ return attribs_; }
  private:
    bool hasXmlRoot();
    std::vector<std::shared_ptr<AbstractXmlElement>> children_;
	std::vector<std::pair<std::string, std::string>> attribs_;
